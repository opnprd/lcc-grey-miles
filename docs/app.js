(function (Vue, Vuex) {
	...
	*/
	...
	var script$4 = {
	  ...
	  computed: {
	    sortedModes: function sortedModes() {
	      if (!this.$store.state.driving) return [];else {
	        var j = this.$store.getters.journey;
	        return _toConsumableArray(this.modes).sort(function (a, b) {
	          return a.co2Fn(j) - b.co2Fn(j);
	        });
	      }
	    }
	  } // created() {
	...
	var __vue_render__$4 = function() {
	  ...
	  return _c("article", { attrs: { id: "app" } }, [
	    ...
	    _c("div", { attrs: { id: "main" } }, [
	      ...
	      _vm._v(" "),
	      _vm.sortedModes.length != 0
	        ? _c(
	            "ol",
	            { staticClass: "modes" },
	            _vm._l(_vm.sortedModes, function(mode, i) {
	              return _c(
	                "li",
