(function (Vue, Vuex, google) {
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-356c43e4_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n/* Todo - style properly, hide after selection etc */\nul[data-v-356c43e4] {\n  margin: 5px 0px;\n  width: min(100%, max-content);\n  border: 1px dashed black;\n}\nli[data-v-356c43e4] {\n  padding: 4px 10px;\n  font-size: 0.8em;\n}\n.selected[data-v-356c43e4] {\n  background-color: lightgray;\n}\n", map: {"version":3,"sources":["/Users/gilesdring/src/opnprd/greymiles/src/components/LocationOptions.vue"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA+BA,oDAAA;AACA;EACA,eAAA;EACA,6BAAA;EACA,wBAAA;AACA;AACA;EACA,iBAAA;EACA,gBAAA;AACA;AACA;EACA,2BAAA;AACA","file":"LocationOptions.vue","sourcesContent":["<template>\n  <ul v-if=\"options.length > 0\">\n    <li\n      v-for=\"(o, i) in options\"\n      :key=\"i\"\n      :class=\"{ selected: (selected == i) }\"\n      @click=\"action(i)\"\n    >\n      {{ o.name }}\n    </li>\n  </ul>\n</template>\n<script>\nexport default {\n  props: {\n    action: {\n      default: () => (i) => console.error(`Unimplemented action click ${i}`),\n      type: Function,\n    },\n    options: {\n      default: () => [],\n      type: Array,\n    },\n    selected: {\n      default: () => null,\n      type: Number,\n    },\n  },\n};\n</script>\n<style scoped>\n/* Todo - style properly, hide after selection etc */\nul {\n  margin: 5px 0px;\n  width: min(100%, max-content);\n  border: 1px dashed black;\n}\nli {\n  padding: 4px 10px;\n  font-size: 0.8em;\n}\n.selected {\n  background-color: lightgray;\n}\n</style>"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-356c43e4";
    /* module identifier */
